...
|GET| consulting/wordcloud/happy      | 상담 별 긍정 워드 클라우드 이미지           | ?id={consulting id}    | String(워드 클라우드 바이너리 문자열)      |
|GET| consulting/wordcloud/angry      | 상담 별 부정 워드 클라우드 이미지           | ?id={consulting id}    | String(워드 클라우드 바이너리 문자열)      |
